...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UIImage *goalImage = [UIImage imageNamed:@"activity_a_off"];
    goalImage = [goalImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIImage *goalSelectedImage = [UIImage imageNamed:@"activity_a_off"];
    ...
    UIImage *analyseImage = [UIImage imageNamed:@"activity_a_off"];
    analyseImage = [analyseImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIImage *analyseSelectedImage = [UIImage imageNamed:@"activity_a_off"];
    ...
    UIImage *runImage = [UIImage imageNamed:@"activity_a_off"];
    runImage = [runImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIImage *runSelectedImage = [UIImage imageNamed:@"activity_a_off"];
    ...
    UIImage *signImage = [UIImage imageNamed:@"activity_a_off"];
    
    signImage = [signImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    
    UIImage *signSelectedImage = [UIImage imageNamed:@"activity_a_off"];
    signSelectedImage = [signSelectedImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    signViewController.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"打卡" image:signImage selectedImage:signSelectedImage];
    
    
    // 我
    PLMineViewController *myViewController = [[PLMineViewController alloc] init];
    UIImage *mineImage = [UIImage imageNamed:@"activity_a_off"];
    mineImage = [mineImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIImage *mineSelectedImage = [UIImage imageNamed:@"activity_a_off"];
